package mx.utng.alp.smarthealthmonitor.data.repository
...
import mx.utng.alp.smarthealthmonitor.data.remote.NeonClient
import mx.utng.alp.smarthealthmonitor.data.remote.NeonRequest
    ...
    private suspend fun sincronizarHaciaNeon(lectura: LecturaFC) =
        withContext(Dispatchers.IO) {
            NeonClient.api.executeQuery(
                ...
                request = NeonRequest(
                    query = """INSERT INTO lecturas_fc (bpm, estado, dispositivo, hora) VALUES ($1, $2, $3, $4) RETURNING id""".trimIndent(),
